    ...
    for file_path in file_paths:
        with open(file_path, newline='') as csvfile:
            ...
            for row in reader:
                ...
                scores_dict[label].append(ast.literal_eval(row['Score']))
...
def plot_from_dict(data_dict, plot_title, filename, novelty_intro_idx=None):
    ...
    plt.ylabel('Avg. iterations', fontsize=27)
    ...
    save_dir = os.path.abspath(os.path.join(SCRIPT_DIR, '..', '..', 'plots', 'moving_graph_plots_2'))
...
base_dir = r"results_csv_experiment_2"
