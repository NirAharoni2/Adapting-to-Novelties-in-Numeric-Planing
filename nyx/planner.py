...
import nyx.heuristic_functions as heuristic_functions
from nyx.PDDL import PDDL_Parser
import nyx.syntax.constants as constants
import time, copy, sys
from nyx.syntax.visited_state import VisitedState
from nyx.syntax.state import State

import nyx.semantic_attachments.semantic_attachment as semantic_attachment
    ...
    def solve(self, domain, problem):
        ...
        while self.queue:
            ...
            for aa in state.get_applicable_happenings(grounded_instance.actions):
                ...
                if new_state.time <= constants.TIME_HORIZON and new_state.depth <= constants.DEPTH_LIMIT and grounded_instance.duration_constraints(new_state,
                                                                                                                                                    constants):
