(define (domain polycraft)
    ...
    (:action get_log
     ...
     :precondition (and
            (>= (trees_in_map ) 1))
     :effect (and
            (assign (count_log_in_inventory ) (+ (* 0.0 (* (count_log_in_inventory ) (count_log_in_inventory ))) (+ (* 0.0 (* (count_log_in_inventory ) (count_planks_in_inventory ))) (+ (* -0.0 (* (count_log_in_inventory ) (count_pogo_stick ))) (+ (* -0.0 (* (count_log_in_inventory ) (count_sack_polyisoprene_pellets_in_inventory ))) (+ (* 0.0 (* (count_log_in_inventory ) (count_stick_in_inventory ))) (+ (* -0.0 (* (count_log_in_inventory ) (count_tree_tap_in_inventory ))) (+ (* 0.0 (* (count_planks_in_inventory ) (count_planks_in_inventory ))) (+ (* 0.0 (* (count_planks_in_inventory ) (count_pogo_stick ))) (+ (* 0.0 (* (count_planks_in_inventory ) (count_sack_polyisoprene_pellets_in_inventory ))) (+ (* -0.0 (* (trees_in_map ) (count_log_in_inventory ))) (+ (* -0.0 (* (trees_in_map ) (count_planks_in_inventory ))) (+ (* -0.0 (* (trees_in_map ) (trees_in_map ))) (+ (* 1.0 (count_log_in_inventory )) (+ (* 0.0 (count_planks_in_inventory )) (+ (* 0.0 (trees_in_map )) 0.5))))))))))))))))
            (assign (trees_in_map ) (+ (* 0.0 (* (count_log_in_inventory ) (count_log_in_inventory ))) (+ (* 0.0 (* (count_log_in_inventory ) (count_planks_in_inventory ))) (+ (* -0.0 (* (count_log_in_inventory ) (count_pogo_stick ))) (+ (* -0.0 (* (count_log_in_inventory ) (count_sack_polyisoprene_pellets_in_inventory ))) (+ (* -0.0 (* (count_log_in_inventory ) (count_stick_in_inventory ))) (+ (* 0.0 (* (count_log_in_inventory ) (count_tree_tap_in_inventory ))) (+ (* 0.0 (* (count_planks_in_inventory ) (count_planks_in_inventory ))) (+ (* 0.0 (* (count_planks_in_inventory ) (count_pogo_stick ))) (+ (* 0.0 (* (count_planks_in_inventory ) (count_sack_polyisoprene_pellets_in_inventory ))) (+ (* 0.0 (* (trees_in_map ) (count_log_in_inventory ))) (+ (* -0.0 (* (trees_in_map ) (count_planks_in_inventory ))) (+ (* 0.0 (* (trees_in_map ) (trees_in_map ))) (+ (* -0.0 (count_log_in_inventory )) (+ (* 0.0 (count_planks_in_inventory )) (+ (* 1.0 (trees_in_map )) -0.5)))))))))))))))))
    )
    (:action craft_plank
     :parameters ()
     :precondition (and
